...
eng_file = "Jan-engagement.xlsx" # Engagement file to read`
# eng_file = "ml-jan.xlsx" # Engagement file to read`
area_path = r"Content\Production\Data and AI\AI Foundry" # area path for querying ADO
# area_path = r"Content\Production\Data and AI\Machine Learning" # area path for querying ADO
...
articles['ms.date'] = articles['ms.date'].fillna(articles['LastReviewed'])
